...
def decodTag_Orient(tag):
    ...
    if np.mean(np.reshape(tag[y[2]:y[2]+20, x[2]:x[2]+20],(400, 1))) >=128:
        orientation = np.pi
    elif np.mean(np.reshape(tag[y[2]:y[2]+20, x[5]:x[5]+20],(400, 1))) >=128:
        orientation = np.pi/2
    elif np.mean(np.reshape(tag[y[5]:y[5]+20, x[2]:x[2]+20],(400, 1))) >=128:
        orientation = 3*np.pi/2
    elif np.mean(np.reshape(tag[y[5]:y[5]+20, x[5]:x[5]+20],(400, 1))) >=128:
        orientation = 0
    else:
    ...
    if orientation == 0:
        ...
        if np.mean(np.reshape(tag[y_bin[0]:y_bin[0]+20, x_bin[0]:x_bin[0]+20],(400, 1))) >=128:
            ID += 1
        if np.mean(np.reshape(tag[y_bin[0]:y_bin[0]+20, x_bin[1]:x_bin[1]+20],(400, 1))) >=128:
            ID += 2
        if np.mean(np.reshape(tag[y_bin[1]:y_bin[1]+20, x_bin[1]:x_bin[1]+20],(400, 1))) >=128:
            ID += 4
        if np.mean(np.reshape(tag[y_bin[1]:y_bin[1]+20, x_bin[0]:x_bin[0]+20],(400, 1))) >=128:
            ID += 8
...
def main(): 
    ...
    while(True):
        ...
        pos_tag = np.array([[0,0], [159,0], [159,159], [0,159]]) # Corners 
        ...
        print("Tag ID: ", tag_id)
        print("Tag Orientation: ", tag_orient)
